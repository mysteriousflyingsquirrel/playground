---
name: github-publish
description: Delegate GitHub publication to github-clanker. Use when the user types `/github-publish #123` to commit the current reviewed branch, push it, and create or update a PR into dev.
...
- Required issue number or issue link, as in **`/github-publish #123`**.
...
4. Do not replace the subagent with inline commit or PR work unless delegation is impossible.
